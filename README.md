...
Pi-hole is a network-wide ad blocker and plays no part in routing (profile `pihole`, or `full`).
...
sitting under `tools`, and only `full` starts it. To add it to the default set:
